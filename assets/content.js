...
const CONTENT = {
  ...
  fr: {
    ...
    hero: {
      ...
      intro: 'Je viens de deux formations qui se croisent rarement, la science politique à Sciences Po Saint-Germain-en-Laye et l’ingénierie data à CY Tech. J’en ai tiré une méthode de travail simple : <mark>comprendre un terrain, puis le mesurer</mark>. Je l’applique aujourd’hui en Afrique centrale, sur la veille médiatique, l’analyse d’influence et les modèles prédictifs.',
      meta: [
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            meta: ['Lectures'],
            body: 'Lecture suivie de revues à comité de lecture en économie, défense et aéronavale, d’ouvrages d’histoire et de la presse spécialisée sur l’Afrique.',
            logos: [
  ...
  en: {
    ...
    hero: {
      ...
      intro: 'I come from two fields that rarely meet, political science at Sciences Po Saint-Germain-en-Laye and data engineering at CY Tech. Both taught me the same method: <mark>understand the ground, then measure it</mark>. I apply it today in Central Africa, on media monitoring, influence analysis and predictive models.',
      meta: [
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            meta: ['Reading'],
            body: 'Regular reading of peer-reviewed journals in economics, defence and naval aviation, history books and specialised Africa coverage.',
            logos: [
              { name: 'Passés composés', logo: 'assets/logos/passe-compose.png', url: 'https://passes-composes.com', wide: true, short: 'PC' },
              { name: 'CNRS', logo: 'cnrs.fr', url: 'https://www.cnrs.fr' },
